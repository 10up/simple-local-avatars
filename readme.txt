...
* **Added:** class and ID to Avatar section on Profile Page to allow easier styling of the section (props [@dinhtungdu](https://profiles.wordpress.org/dinhtungdu/))
...
* **Changed:** `assign_new_user_avatar` function made public (props [@tripflex](https://profiles.wordpress.org/tripflex/))
...
* **Removed:** `get_avatar` fuinction that overrides the core function (props [@dinhtungdu](https://profiles.wordpress.org/dinhtungdu/), [@heyjones](https://github.com/heyjones), [@dkotter](https://profiles.wordpress.org/dkotter/), [@sumnercreations](https://github.com/sumnercreations), [@dshanske](https://profiles.wordpress.org/dshanske/))
