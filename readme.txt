...
* **Changed:** Bumped WordPress "tested up to" version 6.3 (props [@zamanq](https://github.com/zamanq), [@ankitguptaindia](https://github.com/ankitguptaindia), [@faisal-alvi](https://github.com/faisal-alvi) via [#230](https://github.com/10up/simple-local-avatars/pull/230)).
