...
= 2.7.10 - 2024-05-23 =
* **Fixed:** Fix Default Avatar Fallback (props [@amirhossein7](https://wordpress.org/support/users/amirhossein7/), [@faisal-alvi](https://github.com/faisal-alvi), [@dkotter](https://github.com/dkotter), [@qasumitbagthariya](https://profiles.wordpress.org/qasumitbagthariya/) via [#281](https://github.com/10up/simple-local-avatars/pull/281)).
